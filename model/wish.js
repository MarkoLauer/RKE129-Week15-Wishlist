...
const fs = require('fs'); //fs - file system - ligipääs kettale 
...
module.exports = class Wish {
    ...
    saveWish() {
        fs.readFile(filePath, (error, fileContent) => {
            ...
            if(!error){
                wishes = JSON.parse(fileContent); // muudan faili sisu json andmemassiiviks
            }
            else
            {
                console.log(error);
            ...
            wishes.push(this); // lisan uue sisu
